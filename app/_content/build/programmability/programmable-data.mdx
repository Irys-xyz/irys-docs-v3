...
<Callout type="info" emoji="ℹ️">
  This guide assumes you're decently familiar with Solidity smart contract
  development.
</Callout>
...
<Callout type="info" emoji="ℹ️">
  Only transactions uploaded to the permanent ledger (ledgerId 0) can be read
  using programmable data.\ DataItems uploaded through Irys' bundlers are
  currently not supported (but will be!)
</Callout>
...
<Callout type="info" emoji="ℹ️">
  ...
  So only attach a programmable data access list to a transaction that will use
  them!
</Callout>
