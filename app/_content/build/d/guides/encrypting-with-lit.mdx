...
<img className="rounded-xl mt-5" src="/build/guides/lit-protocol/encrypting-onchain-data.png" />
...
<img className="rounded-xl mt-5" src="/build/guides/lit-protocol/decrypting-onchain-data.png" />
...
<Tabs defaultValue="eth" className="mt-6">
  <TabsList>
    <TabsTrigger value="eth">ETH Balance</TabsTrigger>
    <TabsTrigger value="erc20">ERC20 Balance</TabsTrigger>
    <TabsTrigger value="erc721">ERC721 Ownership</TabsTrigger>
  </TabsList>
