...
In addition, Programmable Data also offers _Byte Read Ranges_, which build on top of chunk read ranges to provide easy access to specific parts of a transaction's data.
